...
namespace FL_UnityEngine
{
	public unsafe partial class Physics {
		...
		public static bool BoxCast(UnityEngine.Vector3 center, UnityEngine.Vector3 halfExtents, UnityEngine.Vector3 direction, ref UnityEngine.RaycastHit hitInfo, UnityEngine.Quaternion orientation, float maxDistance, int layerMask, UnityEngine.QueryTriggerInteraction queryTriggerInteraction) => throw new NotImplementedException();
		public static bool BoxCast(UnityEngine.Vector3 center, UnityEngine.Vector3 halfExtents, UnityEngine.Vector3 direction, ref UnityEngine.RaycastHit hitInfo, UnityEngine.Quaternion orientation, float maxDistance, int layerMask) => throw new NotImplementedException();
		public static bool BoxCast(UnityEngine.Vector3 center, UnityEngine.Vector3 halfExtents, UnityEngine.Vector3 direction, ref UnityEngine.RaycastHit hitInfo, UnityEngine.Quaternion orientation, float maxDistance) => throw new NotImplementedException();
		public static bool BoxCast(UnityEngine.Vector3 center, UnityEngine.Vector3 halfExtents, UnityEngine.Vector3 direction, ref UnityEngine.RaycastHit hitInfo, UnityEngine.Quaternion orientation) => throw new NotImplementedException();
		public static bool BoxCast(UnityEngine.Vector3 center, UnityEngine.Vector3 halfExtents, UnityEngine.Vector3 direction, ref UnityEngine.RaycastHit hitInfo) => throw new NotImplementedException();
		...
		public static bool CapsuleCast(UnityEngine.Vector3 point1, UnityEngine.Vector3 point2, float radius, UnityEngine.Vector3 direction, ref UnityEngine.RaycastHit hitInfo, float maxDistance, int layerMask, UnityEngine.QueryTriggerInteraction queryTriggerInteraction) => throw new NotImplementedException();
		public static bool CapsuleCast(UnityEngine.Vector3 point1, UnityEngine.Vector3 point2, float radius, UnityEngine.Vector3 direction, ref UnityEngine.RaycastHit hitInfo, float maxDistance, int layerMask) => throw new NotImplementedException();
		public static bool CapsuleCast(UnityEngine.Vector3 point1, UnityEngine.Vector3 point2, float radius, UnityEngine.Vector3 direction, ref UnityEngine.RaycastHit hitInfo, float maxDistance) => throw new NotImplementedException();
		public static bool CapsuleCast(UnityEngine.Vector3 point1, UnityEngine.Vector3 point2, float radius, UnityEngine.Vector3 direction, ref UnityEngine.RaycastHit hitInfo) => throw new NotImplementedException();
		...
		public static bool ComputePenetration(FL_UnityEngine.Collider colliderA, UnityEngine.Vector3 positionA, UnityEngine.Quaternion rotationA, FL_UnityEngine.Collider colliderB, UnityEngine.Vector3 positionB, UnityEngine.Quaternion rotationB, ref UnityEngine.Vector3 direction, ref float distance) => throw new NotImplementedException();
		...
		public static bool Linecast(UnityEngine.Vector3 start, UnityEngine.Vector3 end, ref UnityEngine.RaycastHit hitInfo, int layerMask, UnityEngine.QueryTriggerInteraction queryTriggerInteraction) => throw new NotImplementedException();
		public static bool Linecast(UnityEngine.Vector3 start, UnityEngine.Vector3 end, ref UnityEngine.RaycastHit hitInfo, int layerMask) => throw new NotImplementedException();
		public static bool Linecast(UnityEngine.Vector3 start, UnityEngine.Vector3 end, ref UnityEngine.RaycastHit hitInfo) => throw new NotImplementedException();
		...
		public static bool Raycast(UnityEngine.Vector3 origin, UnityEngine.Vector3 direction, ref UnityEngine.RaycastHit hitInfo, float maxDistance, int layerMask, UnityEngine.QueryTriggerInteraction queryTriggerInteraction) => throw new NotImplementedException();
		public static bool Raycast(UnityEngine.Vector3 origin, UnityEngine.Vector3 direction, ref UnityEngine.RaycastHit hitInfo, float maxDistance, int layerMask) => throw new NotImplementedException();
		public static bool Raycast(UnityEngine.Vector3 origin, UnityEngine.Vector3 direction, ref UnityEngine.RaycastHit hitInfo, float maxDistance) => throw new NotImplementedException();
		public static bool Raycast(UnityEngine.Vector3 origin, UnityEngine.Vector3 direction, ref UnityEngine.RaycastHit hitInfo) => throw new NotImplementedException();
		...
		public static bool Raycast(UnityEngine.Ray ray, ref UnityEngine.RaycastHit hitInfo, float maxDistance, int layerMask, UnityEngine.QueryTriggerInteraction queryTriggerInteraction) => throw new NotImplementedException();
		public static bool Raycast(UnityEngine.Ray ray, ref UnityEngine.RaycastHit hitInfo, float maxDistance, int layerMask) => throw new NotImplementedException();
		public static bool Raycast(UnityEngine.Ray ray, ref UnityEngine.RaycastHit hitInfo, float maxDistance) => throw new NotImplementedException();
		public static bool Raycast(UnityEngine.Ray ray, ref UnityEngine.RaycastHit hitInfo) => throw new NotImplementedException();
		...
		public static bool SphereCast(UnityEngine.Ray ray, float radius, ref UnityEngine.RaycastHit hitInfo, float maxDistance, int layerMask, UnityEngine.QueryTriggerInteraction queryTriggerInteraction) => throw new NotImplementedException();
		public static bool SphereCast(UnityEngine.Ray ray, float radius, ref UnityEngine.RaycastHit hitInfo, float maxDistance, int layerMask) => throw new NotImplementedException();
		public static bool SphereCast(UnityEngine.Ray ray, float radius, ref UnityEngine.RaycastHit hitInfo, float maxDistance) => throw new NotImplementedException();
		public static bool SphereCast(UnityEngine.Ray ray, float radius, ref UnityEngine.RaycastHit hitInfo) => throw new NotImplementedException();
		public static bool SphereCast(UnityEngine.Vector3 origin, float radius, UnityEngine.Vector3 direction, ref UnityEngine.RaycastHit hitInfo, float maxDistance, int layerMask, UnityEngine.QueryTriggerInteraction queryTriggerInteraction) => throw new NotImplementedException();
		public static bool SphereCast(UnityEngine.Vector3 origin, float radius, UnityEngine.Vector3 direction, ref UnityEngine.RaycastHit hitInfo, float maxDistance, int layerMask) => throw new NotImplementedException();
		public static bool SphereCast(UnityEngine.Vector3 origin, float radius, UnityEngine.Vector3 direction, ref UnityEngine.RaycastHit hitInfo, float maxDistance) => throw new NotImplementedException();
		public static bool SphereCast(UnityEngine.Vector3 origin, float radius, UnityEngine.Vector3 direction, ref UnityEngine.RaycastHit hitInfo) => throw new NotImplementedException();
