...
{
	public unsafe partial class TrailRenderer : FL_UnityEngine.Renderer {
		//public TrailRenderer() { }
		public void AddPosition(UnityEngine.Vector3 position) => throw new NotImplementedException();
		public void AddPositions(UnityEngine.Vector3[] positions) => throw new NotImplementedException();
		...
		public bool autodestruct { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
		public FL_UnityEngine.Gradient colorGradient { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
		public bool emitting { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
		...
		public float minVertexDistance { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
		...
		public int positionCount => throw new NotImplementedException();
