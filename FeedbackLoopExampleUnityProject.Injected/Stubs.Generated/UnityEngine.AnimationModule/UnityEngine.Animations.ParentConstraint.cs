...
{
	public unsafe partial class ParentConstraint : FL_UnityEngine.Behaviour {
		public virtual int AddSource(UnityEngine.Animations.ConstraintSource source) => throw new NotImplementedException();
		public UnityEngine.Vector3 GetRotationOffset(int index) => throw new NotImplementedException();
		...
		public UnityEngine.Vector3 GetTranslationOffset(int index) => throw new NotImplementedException();
		public virtual void RemoveSource(int index) => throw new NotImplementedException();
		public void SetRotationOffset(int index, UnityEngine.Vector3 value) => throw new NotImplementedException();
		...
		public void SetTranslationOffset(int index, UnityEngine.Vector3 value) => throw new NotImplementedException();
		...
		public UnityEngine.Vector3[] rotationOffsets { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
		...
		public UnityEngine.Vector3[] translationOffsets { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
